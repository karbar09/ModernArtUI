...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setAdapter(new GridViewItemAdapter(this,gridItems));
        	...
        	public void onProgressChanged(SeekBar seekBar, int progress,
        		...
        		for (int i = 0;i<length;i++) {
        			...
        			if (i % 8 == 0) {
            			...
            			textView.setBackgroundColor(GridViewItemAdapter.getColorFromPosition(i, progress));
        			}
        			((GridViewItemAdapter) gridView.getAdapter()).setItem(i,gridItem);
        		}
        	}
